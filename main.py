...
def load_model(model_name):
    if model_name == "plantiq8a1-deepthink-lite":
        module = importlib.import_module("model_1") # U can change file name here 
...
if __name__ == "__main__":
    ...
    cauhoi = "Cây cà chua bị vàng lá thì làm sao khắc phục?" # Example question (u can change here using input) - cauhoi = input("Please write your question here:")
